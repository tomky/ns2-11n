...
// 
// $Header: /nfs/jade/vint/CVSROOT/ns-2/indep-utils/webtrace-conv/nlanr/tr-stat.cc,v 1.3 2005/09/18 23:33:33 tomh Exp $
...
double lf_analyze(lf_entry& lfe)
{
	...
	if (!(he = Tcl_FindHashEntry(&cidHash, (const char *)clientKey))) {
		...
		Tcl_SetHashValue(he, (long)++client);
		cid = client;
	} else {
